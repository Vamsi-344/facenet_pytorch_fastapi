...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(os.path.dirname(__file__), 'model/pnet.pt')
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(os.path.dirname(__file__), 'model/rnet.pt')
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = os.path.join(os.path.dirname(__file__), 'model/onet.pt')
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
